...
public class OrderPlace extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField1.setBounds(700, 360, 260, 40);
        ...
        jButton1.setBounds(590, 510, 230, 60);
        ...
        jComboBox1.setBounds(700, 422, 260, 40);

        jTextField3.setFont(new java.awt.Font("Calibri", 0, 20)); // NOI18N
        jTextField3.setForeground(new java.awt.Color(51, 51, 51));
        jPanel1.add(jTextField3);
        jTextField3.setBounds(700, 300, 260, 40);
        jPanel1.add(jLabel7);
        jLabel7.setBounds(-160, 170, 1400, 640);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int flag=0;
        String Cust_id = jTextField2.getText().toString();
        String item_id = jTextField3.getText().toString();
        String item_qty= jTextField1.getText().toString();
        ...
        if(item_id.equals(""))
        JOptionPane.showMessageDialog(null,"item id Name cannot be Empty.");
        if(item_qty.equals(""))
        JOptionPane.showMessageDialog(null,"qty cannot be Empty.");
        ...
        if(flag==1){
            ...
            try{
                ...
                rs.next();
                int i=rs.getInt(1);
                JOptionPane.showMessageDialog(null,i + " Is The New Id for Order Id!! ");
                con.close();
