 ...
 */
public class MenuRemove extends javax.swing.JFrame {

    /**
     * Creates new form MenuRemove
     */
    public MenuRemove() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Remove Item From Menu");
        ...
        jButton1.setBounds(550, 480, 230, 60);
        ...
        jPanel1.add(jLabel6);
        jLabel6.setBounds(450, 340, 230, 40);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        int flag=0;
        String item_id = jTextField2.getText().toString();
        if(item_id.equals(""))
        JOptionPane.showMessageDialog(null,"Item Id cannot be blank");
        else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuRemove.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
